...
All scenarios have 1 chromosome, 1 family F1, progeny size of 150 individuals, 504 markers, 6 cores and overlap of 5 markers.
...
save.image("data/results1.RData")
```
...
for(i in 1:length(tot.cen)){
  ...
  colnames(temp.int) <- paste0("MK",1:length(temp.int))
  colnames(temp.par) <- paste0("MK",1:length(temp.par))
